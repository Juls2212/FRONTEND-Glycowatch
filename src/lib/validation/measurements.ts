...
export const dashboardManualMeasurementSchema = z
  .object({
    ...
    measuredAt: z
      .string()
      .trim()
      .min(1, "Selecciona fecha y hora de medicion.")
      .max(DATETIME_TEXT_MAX_LENGTH, "La fecha y hora de medicion son demasiado largas.")
  })
...
export const manualMeasurementFormSchema = z
  .object({
    ...
    measuredDate: z
      ...
      .trim()
      .min(1, "Selecciona fecha y hora de medicion.")
      .max(DATE_TEXT_MAX_LENGTH, "La fecha de medicion es demasiado larga."),
    measuredTime: z
      .string()
      .trim()
      .min(1, "Selecciona fecha y hora de medicion.")
      .max(TIME_TEXT_MAX_LENGTH, "La hora de medicion es demasiado larga.")
  })
  .superRefine((values, ctx) => {
